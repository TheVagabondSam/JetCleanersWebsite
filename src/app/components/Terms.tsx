        ...
        <section className="h-[100%] flex w-full items-center justify-center md:justify-center">
            <div className=" w-full max-w-4xl h-full items-center text-center space-y-2 justify-center">
                ...
                <div className="flex w-[100%] wrap-anywhere h-[100%] justify-center m-auto text-logo-blue p-1">
                        ...
                        <p>
                            Our Service may contain links to third-party web sites or services that are not owned or controlled by Jet Cleaners Ltd
                        </p>
                        ...
                        <p>We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revision is material we will try to provide at least 30 days notice prior to any new terms taking effect. 
