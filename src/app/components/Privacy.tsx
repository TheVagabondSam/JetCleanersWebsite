...
export function SectionPrivacy() {
    return (
        <div>
            <section className="h-[100%] flex w-full items-center justify-center md:justify-center">
            <div className=" w-full max-w-4xl h-full items-center text-center space-y-2 justify-center">
                <h1 className="font-bold max-w-4xl w-full h-full m-auto">
                    PRIVACY POLICY
                </h1>
                ...
                <div className="flex w-[100%] wrap-anywhere h-[100%] justify-center m-auto text-logo-blue p-1">
                        ...
                        <p>
                            Jet Cleaners Ltd (“us”, “we”, or “our”) operates Jet Cleaners Ltd Website (the “Service”).
                            This page informs you of our policies regarding the collection, use and disclosure of Personal Information when you use our Service.
                        </p>

                        <p>
                            We will not use or share your information with anyone except as described in this Privacy Policy.
                            We use your Personal Information for providing and improving the Service. By using then Service, you agree to the collection and use of information in accordance with this policy. 
                            Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible at jetcleaners.uk
                        </p>                   
                        ...
                        <p>
                            ...
                            and stored on your computer’s hard drive. We use 
                        ...
                        <p>
                            ...
                            other sites that are not operated by us.
                        ...
                        <p>
                            ...
                            under 18. If you are a parent or guardian
                            and you are aware that your child has 
                            provided us with Personal Information, 
                            please contact us. If we discover that
                            a child under 18 has provided us with 
                            Personal Information, we will delete 
                        ...
                        <p>
                            ...
                            where required to do so by law or subpoena
                        </p>
                        <h2 className="text-black">
